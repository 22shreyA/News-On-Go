...
public class EntertainmentFragment extends Fragment {
    ...
    String country = "in";
    private RecyclerView entertainmentecyclerView;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable
        ...
        entertainmentecyclerView = view.findViewById(R.id.entertainmentrecyclerview);
        modelClassArrayList = new ArrayList<>();
        entertainmentecyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        adapter = new Adapter(getContext(),modelClassArrayList);
        entertainmentecyclerView.setAdapter(adapter);
